...
public class image {
	...
	public image(String bookname, String author,String c, String colourname){
		new image(bookname, author, c, colourname, false, 0);
	}
	
	public image(String bookname, String author, String c, String colourname, boolean tint, int pageNumber){ //Shane I added the page number so that I could save multiple page images.
		try {
		    ...
		    File f = new File("resources/tweetimages/" + pageNumber + ".png");
