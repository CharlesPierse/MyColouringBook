...
public class tweetPicker {
	...
	private final String type1 = "resources"+File.separator+"retweeted"+File.separator+"type1.txt";
	private final String type2 = "resources"+File.separator+"retweeted"+File.separator+"type2.txt";
	private final String type3 = "resources"+File.separator+"retweeted"+File.separator+"type3.txt";
	...
	public tweetPicker(ArrayList<ArrayList<String>> tweets){
		...
		if(cur.get(0)=="Type 1")status = new StatusUpdate("@"+user+" "+getType1(title,"<CAT>")+" "+hashtag);
		if(cur.get(0)=="Type 2")status = new StatusUpdate("@"+user+" "+getType2(title,author,"<CAT>")+" "+hashtag);
		if(cur.get(0)=="Type 3")status = new StatusUpdate("@"+user+" "+getType3(title,author,"<CAT>")+" "+hashtag);
	...
	private String getType1(String book, String catagory){
		int put = 0;
        String line = null;
        String output = "";
        try {
            FileReader fileReader = new FileReader(type1);
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            while((line = bufferedReader.readLine()) != null) {
                String tokes[] = line.split("\t");
                Random random = new Random();
                output = output+tokes[random.nextInt(tokes.length)];
                if(put==0){
                	output = output+" "+book;
                	put++;
                }else if(put==1){
	...
	private String getType2(String book, String author, String catagory){
		int put = 0;
        String line = null;
        String output = "";
        try {
            FileReader fileReader = new FileReader(type2);
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            while((line = bufferedReader.readLine()) != null) {
                String tokes[] = line.split("\t");
                Random random = new Random();
	...
	private String getType3(String book, String author, String catagory){
		int put = 0;
        String line = null;
        String output = "";
        try {
            FileReader fileReader = new FileReader(type3);
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            while((line = bufferedReader.readLine()) != null) {
                String tokes[] = line.split("\t");
                Random random = new Random();
